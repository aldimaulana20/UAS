...
//cek button    
    ...
    $input    ="INSERT INTO data_pendaftar(no,jumlah_positif,jumlah_dirawat,jumlah_sembuh,jumlah_meninggal,wilayah) 
                    VALUES ('$no','$jumlah_positif','$jumlah_dirawat','$jumlah_sembuh','$jumlah_meninggal','$prov')";
